...
$('#portfolioModal').on('show.bs.modal', function (event) {
    ...
    const portfolioDetailsMap = {
        'pce': {
            ...
            'image_url': isMobile ? 'static/img/pce-mobile.gif' : 'static/img/pce.gif',
            'tools': [
                'Vue.js',
                'Vuetify',
                'Laravel PHP',
        ...
        'makkiah': {
            ...
            'image_url': isMobile ? 'static/img/makkiah-in-modal-mobile.png' : 'static/img/makkiah-in-modal.png',
            'tools': [
                'React',
                'Ant Design',
                'Laravel PHP',
